...
const Card = (props) => {
    const { header, headerStyle, footer, footerStyle, accent, accentDark, accentLight, children, bodyStyle, orientation = "column", style, elevation = 1, borderRadius = "small" } = props;
    let style_ = {};
